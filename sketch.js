...
const askComputerScienceQuestion = () => {
    ...
    errorMessage.textContent = "Bot: Sorry, I didn't understand that. Please ask about an computer science term or request a practice question by typing question";
